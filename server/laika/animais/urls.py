...
urlpatterns = [
    ...
    path('animais/gatos/', views.GatosLista.as_view()),
    path('animais/gatos/<int:pk>/', views.GatoDetalhe.as_view()),
    path('usuarioanimais/usuariogatos/', views.UserGatosLista.as_view()),
    path('usuarioanimais/usuariogatos/<int:pk>', views.UserGatoDetalhe.as_view()),
]
